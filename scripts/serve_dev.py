...
class MockAPIRequestHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def _handle_api_challenges_results(self, challenge_id: str) -> bool:
        ...
        if not results and challenge_id in ("mock-ch-1", "mock-ch-2", "mock-ch-3"):
            results = [
                {"id": "r1", "rank": 1, "displayName": "Alice R.", "boatType": "1x", "sex": "F", "crewAvgAge": 28, "rawTimeS": 1320, "courseDistanceM": 5000, "correctedTimeS": 1280, "points": 98.5, "workoutDate": "2026-03-10", "validationStatus": "valid"},
                {"id": "r2", "rank": 2, "displayName": "Bob M.", "boatType": "1x", "sex": "M", "crewAvgAge": 35, "rawTimeS": 1280, "courseDistanceM": 5000, "correctedTimeS": 1290, "points": 97.2, "workoutDate": "2026-03-12", "validationStatus": "valid"},
                {"id": "r3", "rank": 3, "displayName": "Crew Masters 8+", "boatType": "8+", "sex": "M", "crewAvgAge": 52, "rawTimeS": 1100, "courseDistanceM": None, "correctedTimeS": 1305, "points": 96.1, "workoutDate": "2026-03-14", "validationStatus": "valid"},
            ]
